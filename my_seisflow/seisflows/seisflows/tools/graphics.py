...
#def plot_section_z(stream, ax=None, cmap='seismic', clip=100, title='', x_interval=1.0, y_interval=1.0,x_data_interval=1,y_data_interval=1):
#    """  Plots a seismic section from an obspy stream.
#
#    Parameters
#    ----------
...
#    D_aspect = NR / float(NT)
#    
#    xarange = np.arange(0,len(Data[:,0]),x_data_interval)
#    yarange = np.arange(0,len(Data[0,:]),y_data_interval)
#    
#    data = Data[xarange,yarange]
#    
#    
#    # get dimensions
#    nr = len(yarange)
#    nt = len(xarange)
#    dt = DT * y_data_interval
#    d_aspect = nr / float(nt)
#
#
#    # default values
