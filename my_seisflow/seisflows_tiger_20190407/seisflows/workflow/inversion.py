    ...
    def setup(self):
        ...
        if optimize.iter == 1 or \
           PATH.LOCAL:
            ...
            # generating data is here for inversion, JH.
                print 'Generating data' 
            # solver is 'specfem2d_new',which inherent the base.py in solver
            # /scratch/gpfs/jiazeh/seisflows/seisflows/solver/base.py 
            # 127     def setup(self):
            # 128         """ Prepares solver for inversion or migration
