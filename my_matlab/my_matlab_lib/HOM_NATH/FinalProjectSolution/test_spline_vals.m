...
% QUESTION: find spline value for q=8, centerd at (longitude, latitude)=(-117, 34), 
% evaluated at the point (-117.05, 34.25).
clon0 = -117;    clat0 = 34;
lon0 = -117.05;  lat0 = 34.25;
ff0 = spline_vals(clon0, clat0, q, lon0, lat0, {1});
fprintf(1,'sline value evaluated at (%f,%f): %f\n',clon0,clat0,ff0);
