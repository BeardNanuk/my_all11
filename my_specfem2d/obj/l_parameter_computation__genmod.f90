        ...
        MODULE L_PARAMETER_COMPUTATION__genmod
          INTERFACE 
            SUBROUTINE L_PARAMETER_COMPUTATION(DELTAT,KAPPA_X,BETA_X,   &
     &ALPHA_X,KAPPA_Z,BETA_Z,ALPHA_Z,CPML_REGION_LOCAL,A_0,A_1,A_2,A_3, &
     &A_4,BB_1,COEF0_1,COEF1_1,COEF2_1,BB_2,COEF0_2,COEF1_2,COEF2_2)
