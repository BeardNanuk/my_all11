        ...
        MODULE LIK_PARAMETER_COMPUTATION__genmod
          INTERFACE 
            SUBROUTINE LIK_PARAMETER_COMPUTATION(DELTAT,KAPPA_X,BETA_X, &
     &ALPHA_X,KAPPA_Z,BETA_Z,ALPHA_Z,CPML_REGION_LOCAL,INDEX_IK,A_0,A_1,&
     &A_2,BB_1,BB_2,COEF0_1,COEF1_1,COEF2_1,COEF0_2,COEF1_2,COEF2_2)
